...
<div id="articles" class="container-fluid mt-5">
    ...
    <div class=" d-flex justify-content-center flex-wrap">
        ...
        <?php 
            //Ici nous allons récuperer le contenu du fichier data.json
            $listing_enchere = file_get_contents('../data/data.json', true);
            // echo $listing_enchere;
        ?>
        ...
        <div class="card  shadow m-lg-4" style="width: 18rem;">
            <div class="duree d-flex position-absolute w-50 justify-content-center align-items-center font-weight-bold"
                id="<?= $items->id?>"></div>
            <img src="../../img/<?= htmlentities($items->image_nom,ENT_QUOTES) ?>"
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    <a href="?id=<?php echo htmlentities($items->id, ENT_QUOTES)?>" class="btn btn-primary btn-listEnchere p-0" name="submit">Enchérir</a>
                </div>
            </div>
        </div>
