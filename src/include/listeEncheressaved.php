...
<div id="articles" class="container-fluid mt-5">
    ...
    <div class=" d-flex justify-content-center flex-wrap">
        <?php //Ici on recupere le contenu dans le fichier data.json
            ...
            <?php if($listing_enchere->active_enchere == "Actif"): //Ici on affiche uniquement les elements actifs?>
                <div class="card  shadow m-lg-4" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="display-6 font-weight-bold"><?= htmlentities($listing_enchere->prix_depart,ENT_QUOTES) ?> €</h4>
                        ...
                        <div class="text-center">
                            <a href="<?php echo __ROOT__.'/index.php?id=' . htmlentities($listing_enchere->id,ENT_QUOTES)?>" class="btn btn-primary btn-listEnchere p-0" name="submit">Enchérir</a>
                        </div>
                    </div>
                </div>
                ...
                <script>
                    var timer = setInterval(function countDown() {
                        ...
                        var timeRemaining = <?php echo $listing_enchere->prix_clic;?> - heure;
                        ...
                        if (timeRemaining <= 0) {
                            document.getElementById('<?= $listing_enchere->prix_clic;?>').innerHTML = "EXPIRE";
                        }
