...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger text-white font-weight-bold" href="enchereManager.php" id="encherenav">Enchère manager</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <?php
        ...
        require_once(__ROOT__.'/include/formEnchere.php');
    ?>  
